...
>   Remarques importantes : - Représentation spectrale numérique des fonctions - Calcul de produit matriciel - Notion de matrice dense et de matrice creuse/sparse
...
>   Remarque importantes : - Choix de la base d'essaie et la base de test - Diagonalité d'un matrice diagoanle décalée
...
>   Remarques importantes : - LHS, simplicité de la méthode tau en pratique - RHS, attention au terme ajouté - Permutation des lignes dans la représentation matricielle
...
>   Remarques importantes : - Diagonalité de la matrice de changement de base - Expression des conditions aux limites - Matrice à bande

### 2.3. Systèmes d'équations au-delà du premier ordre

1.  Introduction : changement de point de vue

    1.  Principe : d'une équation d'ordre $$N$$ à $$N$$ équations d'ordre un

    2.  Exemple : l'équation de Poisson

    3.  Généralisation à tout système

2.  Résolution des systèmes sous forme d'équations du premier ordre

    1.  Principe de base : une méthode en six étapes

    2.  Exemple : Retour sur l'équation de Poisson

    3.  Généralisation : Application de la méthode bloc par bloc

3.  Renversement de produit de Kronecker

    1.  Définitions : Produit de Kronecker et matrices élementaires

    2.  Rédaction alternative de la méthode bloc par bloc

    3.  Application au résultat de l'équation de Poisson
...
>   Remarques importantes : - Importance de cette partie
...
>   Remarques importantes : - Premier problème, erreur de calcul ? - Second problème, une erreur dans le code ? - Notes personnelles - Termes non linéaires
